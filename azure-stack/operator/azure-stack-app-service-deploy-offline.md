...
> [!IMPORTANT]
> 在运行资源提供程序安装程序之前，请确保已[按照中的指导进行，](azure-stack-app-service-before-you-get-started.md)并阅读了1.7 版本随附的[发行说明](azure-stack-app-service-release-notes-update-seven.md)，了解有关新功能、修复程序以及任何已知问题可能会影响你的部署。
