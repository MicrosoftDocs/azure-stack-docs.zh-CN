...
> [!IMPORTANT]
> 运行资源提供程序安装程序之前，请确保已按照中的指导[在开始之前](azure-stack-app-service-before-you-get-started.md)并已阅读[发行说明](azure-stack-app-service-release-notes-update-six.md)其中附带有 6 了解有关新的版本功能、 修复和可能会影响你的部署任何已知的问题。
...
如果选择部署到现有虚拟网络和内部 IP 地址以连接到文件服务器，则必须添加出站安全规则，以便在工作子网和文件服务器之间启用 SMB 流量。  转到 WorkersNsg，网络安全组，在管理门户中，然后添加出站安全规则具有以下属性：
