---
title: Azure Stack 集线器上的应用服务 Update 4 发行说明 |Microsoft Docs
description: 了解 Azure Stack 集线器上应用服务的更新4中的改进、修复和已知问题。
...
> [!IMPORTANT]
> 在部署 Azure App Service 1.4 之前，将1809更新应用到 Azure Stack 集线器集成系统或部署最新的 Azure Stack 开发工具包（ASDK）。
...
开始将 Azure Stack 中心的 Azure App Service 升级到1.4 之前：
...
- 将**Azure Functions 运行时**更新为**1.0.11959**。
...
- **以下应用框架和工具的更新**：
  - 添加了 NodeJS 10.6。0
  - 添加了 NPM 6.1。0
  - 添加了祖鲁 OpenJDK 8.31.0。2
  - 已添加 Tomcat 8.5.34 和9.0.12
  - 添加了 PHP 版本：
    - 5.6.37
    - 7.0.31
    - 7.1.20
  ...
  - 已将 Kudu 更新为78.11022.3613
  
- **所有角色的基础操作系统更新**：
  - [2018-10 基于 x64 的系统的 Windows Server 2016 累积更新（KB4462928）](https://support.microsoft.com/help/4462928/windows-10-update-kb4462928)
