...
对于存储的可用配置, 可以查看 Azure Stack OEM 合作伙伴 (https://azure.microsoft.com/overview/azure-stack/partners/) 有关详细的规范。
...
### <a name="volume-health-state-healthy"></a>卷运行状况：状态良好
...
### <a name="drive-health-state-healthy"></a>驱动器运行状况：状态良好
