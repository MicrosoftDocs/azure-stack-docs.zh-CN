...
4. 门户将显示可从 Azure 市场下载的项的列表。 可以按名称、发布者和/或产品类型筛选产品。 每个行项还显示当前可用的版本。 如果有多个版本的 Marketplace 项可用，"**版本**" 列会显示**多个**版本。 你可以单击每个项目以查看其描述和其他信息，包括其下载大小：

    [![Marketplace 项列表](media/azure-stack-download-azure-marketplace-item/add-from-azure1sm.png "Marketplace 项列表")](media/azure-stack-download-azure-marketplace-item/add-from-azure1.png#lightbox)

5. 如果某个项的版本显示为**多个**，则可以选择该项目，然后从生成的版本选择器下拉列表中选择特定版本：

    [![选择版本](media/azure-stack-download-azure-marketplace-item/add-from-azure3sm.png "选择版本")](media/azure-stack-download-azure-marketplace-item/add-from-azure3.png#lightbox)

6. 选择所需的项，然后选择“下载”。 下载时间会有差异。
...
6. 当该工具运行时，应会看到类似于下图的屏幕，其中包含可用的 Azure marketplace 项列表：
   ...
   [![Azure 市场项弹出窗口](media/azure-stack-download-azure-marketplace-item/tool1sm.png "Azure 市场项")](media/azure-stack-download-azure-marketplace-item/tool1.png#lightbox)

7. 如果有多个版本的 Marketplace 项可用，"**版本**" 列会显示**多个版本**。 如果项的版本显示为**多个版本**，则可以选择该项，然后从生成的版本选择器窗口中选择特定版本：

   [![版本选择器](media/azure-stack-download-azure-marketplace-item/tool2sm.png "选择版本")](media/azure-stack-download-azure-marketplace-item/tool2.png#lightbox)
