...
要使用云，必须安装与 Azure Stack 兼容的 PowerShell 模块。 Azure Stack 使用 **AzureRM** 模块，而不是全球 Azure 中使用的新型 **AzureAZ** 模块。 你还需要使用 API 配置文件为 Azure Stack 资源提供程序指定兼容的终结点。
