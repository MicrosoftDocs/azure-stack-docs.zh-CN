...
由于 cmdlet 是适用于 Azure Stack Hub 1710 更新包中的新功能，因此 1710 更新过程需要运行到特定的步骤，才能使用监视功能。 一般而言，如果管理员门户中的状态指示 1710 更新正在执行“重启存储主机”步骤，则可以使用 cmdlet。 具体而言，cmdlet 会在 **步骤：运行步骤 2.6-Update PrivilegedEndpoint 允许列表** 中进行更新。
