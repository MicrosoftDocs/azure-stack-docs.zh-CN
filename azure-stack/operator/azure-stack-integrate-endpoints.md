...
Azure Stack Hub 仅支持透明代理服务器。 在使用到传统代理服务器的透明代理上行链路的部署中，必须允许下表中的端口和 URL，以便进行出站通信。 有关配置透明代理服务器的详细信息，请参阅 [Azure Stack 中心的透明代理](azure-stack-transparent-proxy.md)。
