...
description: 了解 Azure Stack 中心集成系统 Azure Stack 中心 PKI 证书要求。
...
::: moniker-end
::: moniker range=">= azs-1903"
- 为版本1903和更高版本循环使用证书时，证书可以由任何企业证书颁发机构或公共证书颁发机构颁发。
::: moniker-end
- 不支持使用自签名证书。
...
| 公共扩展主机 | *.hosting.\<region>.\<fqdn>  (通配符 SSL 证书)  | 公共扩展主机 | 承载。 \<region>\<fqdn> |
