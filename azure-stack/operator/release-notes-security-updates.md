---
title: Azure Stack 发行说明-1908 的安全更新 |Microsoft Docs
description: 了解 Azure Stack 的1908安全更新。
...
由于 Windows 更新的累积性，此更新还包含上个月的安全负载。 此标识符列表反映6月、7月和8月2019的安全负载。
有关这些漏洞的详细信息，请单击前面的链接，或参阅 Microsoft 知识库文章[4511553](https://support.microsoft.com/help/4511553)。
::: moniker-end
...
由于 Windows 更新的累积性，此更新还包含上个月的安全负载。 此标识符列表反映了3月、4月和5月2019的安全负载。
有关这些漏洞的详细信息，请单击上述链接，或者查看 Microsoft 知识库文章 [4499177](https://support.microsoft.com/help/4499177)。
::: moniker-end
