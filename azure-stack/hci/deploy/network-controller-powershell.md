...
ms.locfileid: "92157642"
---
# <a name="deploy-network-controller-using-windows-powershell"></a>使用 Windows PowerShell 部署网络控制器

> 适用于 Azure Stack HCI 版本 20H2；Windows Server 2019

本主题说明如何使用 Windows PowerShell 在一个或多个虚拟机上部署网络控制器功能，该功能 (在 Azure Stack HCI 群集上运行的 Vm) 。 网络控制器是软件定义的网络 (SDN) 的组件。
...
若要了解详细信息，请参阅 [NetworkController](/powershell/module/networkcontroller) 上适用于网络控制器的 Windows PowerShell 参考文档。
...
如果未将 Kerberos 用于网络控制器部署，则必须部署证书。 有关详细信息，请参阅[网络控制器的部署后步骤](/windows-server/networking/sdn/technologies/network-controller/post-deploy-steps-nc)。