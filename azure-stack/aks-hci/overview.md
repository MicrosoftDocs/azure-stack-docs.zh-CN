...
若要开始在本地使用 Azure Kubernetes 服务，请[注册预览版](https://aka.ms/AKS-HCI-Evaluate)（预览版期间没有额外成本），然后参阅[设置 Azure Stack HCI 上的 Azure Kubernetes 服务](setup.md)。 若要改为使用 Azure Kubernetes 服务协调基于云的容器，请参阅 [Azure 中的 Azure Kubernetes 服务](/azure/aks/intro-kubernetes)。

以下部分讨论了使用 Azure Stack HCI 上的 Azure Kubernetes 服务的一些原因，并回答了有关该服务以及如何开始使用的一些常见问题。 对应容器的背景，请参阅 [ 和容器](/virtualization/windowscontainers/about/)。
...
有关一般 Azure Stack HCI 系统要求，请参阅 [AZURE STACK hci 系统要求](../hci/concepts/system-requirements.md)。
