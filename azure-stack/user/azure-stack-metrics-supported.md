...
ms.locfileid: "68418487"
---
# <a name="supported-metrics-for-azure-monitor-on-azure-stack"></a>Azure Stack Azure Monitor 支持的指标

适用对象：*Azure Stack 集成系统*

检索来自 Azure Stack 上的 Azure monitor 的指标, 其方式与在全球 Azure 中相同。 可以在门户中创建你的度量值、 从 REST API 获取它们或使用 PowerShell 或 CLI 查询它们。

下表列出了 Azure Stack 上 Azure Monitor 的指标管道可用的指标。 若要查询和访问这些指标, 请使用 API 配置文件的**2018-01-01** api 版本。 有关 API 配置文件和 Azure Stack 的详细信息，请参阅[管理 Azure Stack 中的 API 版本配置文件](azure-stack-version-profiles.md)。

## <a name="microsoftcomputevirtualmachines"></a>Microsoft.Compute/virtualMachines

| 指标 | 指标显示名称 | 单位 | 聚合类型 | 说明 | 维度 |
|----------------|---------------------|---------|------------------|-----------------------------------------------------------------------------------------------|---------------|
| CPU 百分比 | CPU 百分比 | 百分比 | Average | VM 当前正在使用的已分配计算单元的百分比。 | 无维度 |
