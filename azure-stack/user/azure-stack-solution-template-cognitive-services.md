...
- **可移植的体系结构**  
  启用可移植应用体系结构的创建，以便可以将你的解决方案部署到公有云，私有云上本地或边缘。 可将容器部署到 Azure Kubernetes 服务，Azure 容器实例，或到 Azure Stack 中的 Kubernetes 群集。 有关详细信息，请参阅[将 Kubernetes 部署到 Azure Stack](azure-stack-solution-template-kubernetes-deploy.md)。
