...
若要查看执行这些操作的代码，请参阅 GitHub 存储库 **Hybrid-Compute-Python-Manage-VM** 中的 Python 脚本 **example.py** 中的 [run_example()](https://github.com/Azure-Samples/Hybrid-Compute-Python-Manage-VM) 函数。
