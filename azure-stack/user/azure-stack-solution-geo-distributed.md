...
ms.locfileid: "68286939"
---
# <a name="create-a-geo-distributed-app-solution-to-direct-traffic-with-azure-and-azure-stack"></a>创建异地分布式应用程序的解决方案将使用 Azure 和 Azure Stack 的流量定向
...
通过这篇文章将生成的解决方案并不是满足可伸缩性。 但是，如果与其他 Azure 和本地解决方案结合使用，可以满足可伸缩性要求。 有关通过流量管理器创建可自动缩放的混合解决方案的信息，请参阅[在 Azure 中创建跨云缩放解决方案](azure-stack-solution-cloud-burst.md)。
...
-   [创建应用服务应用](https://docs.microsoft.com/azure/app-service/)，或使用为另一个解决方案创建的应用。
