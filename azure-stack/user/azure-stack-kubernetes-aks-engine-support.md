...
如果在 Azure Stack 的一个或多个组件或 Kubernetes 提供程序的一个或多个组件中发现了安全漏洞，Microsoft 将为客户提供修补受影响的群集的修补程序，以解决此问题。 或者，团队将向用户授予升级指导。 请注意，修补程序可能需要群集的停机时间。 需要重新启动时，Microsoft 会通知客户此要求。 如果用户未按照 Microsoft 指导应用修补程序，则其群集将继续容易受到安全问题的影响。
