...
description: 若要连接到 Azure Stack 使用 PowerShell 的步骤。
...
ms.locfileid: "64986248"
---
# <a name="connect-to-azure-stack-with-powershell-as-a-user"></a>以用户身份使用 PowerShell 连接到 Azure Stack

*适用于：Azure Stack 集成系统和 Azure Stack 开发工具包*

你可以连接到 Azure Stack 使用 PowerShell。 必须使用 PowerShell 连接以管理 Azure Stack 资源。 例如，可以使用 PowerShell 来订阅套餐、创建虚拟机和部署 Azure 资源管理器模板。
...
配置从这些系统必备组件[开发工具包](../asdk/asdk-connect.md#connect-to-azure-stack-using-rdp)，或基于 Windows 的外部客户端是否[通过 VPN 建立连接](../asdk/asdk-connect.md#connect-to-azure-stack-using-vpn):
