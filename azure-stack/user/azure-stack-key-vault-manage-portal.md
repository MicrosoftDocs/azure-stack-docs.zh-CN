...
ms.locfileid: "66836856"
---
# <a name="manage-key-vault-in-azure-stack-using-the-portal"></a>管理 Azure Stack 使用门户中的密钥保管库
...
创建密钥保管库后，使用以下过程来创建和管理密钥和机密，保管库中。
...
4. 在“创建机密”  下，从“上传选项”  列表中选择需要用来创建机密的选项。 您可以创建一个机密**手动**如果你为机密，输入一个值，或上载**证书**从本地计算机。
