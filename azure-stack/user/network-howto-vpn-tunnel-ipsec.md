---
title: 在 Azure Stack 集线器中使用 IPSEC 创建 VPN 隧道
...
![此关系图显示了一个实现，该实现在两个 Vnet 之间提供 VPN 隧道。 每个 VNET、内部子网和隧道子网中都有 RRAS 服务器。](./media/azure-stack-network-howto-vpn-tunnel-ipsec/overview.png)
...
![标题为 S2SVPNTunnel 的关系图显示了两个由站点到站点 VPN 隧道连接的 Vnet。](./media/azure-stack-network-howto-vpn-tunnel-ipsec/s2svpntunnel.png)
