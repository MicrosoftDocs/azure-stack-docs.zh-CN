...
description: 开始开发 Azure Stack 的应用程序。
...
IaaS 是来自网络设备、网络和服务器的数据中心部分的虚拟化。 当你将应用程序部署到承载 web 服务器的 VM 时，你正在使用 IaaS 模型。 在此模型中，Azure Stack 管理虚拟设备，你的应用程序位于虚拟服务器上。 Azure Stack 的资源提供程序支持网络组件和虚拟服务器。 
...
1. 通过 PowerShell 进行设置。 有关说明，请参阅[Install Azure Stack Powershell](../operator/azure-stack-powershell-install.md)。 
