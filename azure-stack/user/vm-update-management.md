...
在 Azure 门户中启用 Azure 自动化解决方案之后，接下来需要以云管理员身份登录到 Azure Stack 管理员门户，并下载**Azure Monitor、更新和配置管理**以及**Azure Monitor、更新和Azure Stack marketplace 中的 Linux 扩展配置管理**。
