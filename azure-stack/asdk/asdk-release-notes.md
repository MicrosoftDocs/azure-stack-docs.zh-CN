...
- 此版本中修复其他 Azure Stack 问题的列表，请参阅[本节](../operator/azure-stack-release-notes-1905.md#fixes)Azure Stack 的发行说明。
- 有关已知问题的列表，请参阅[这篇文章](../operator/azure-stack-release-notes-known-issues-1905.md)。
